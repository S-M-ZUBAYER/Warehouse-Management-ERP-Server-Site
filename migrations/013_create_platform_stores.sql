...
CREATE TABLE IF NOT EXISTS `platform_stores` (
    ...
    `store_shop_id`       VARCHAR(100)     NULL DEFAULT NULL
        COMMENT 'Platform shop ID (e.g. TikTok shop_id)',
    `store_open_id`       VARCHAR(100)     NULL DEFAULT NULL
        COMMENT 'Platform open/seller ID (e.g. TikTok open_id)',
    `store_cipher`        VARCHAR(255)     NULL DEFAULT NULL
        COMMENT 'Platform cipher / encrypted store token (e.g. TikTok cipher)',
