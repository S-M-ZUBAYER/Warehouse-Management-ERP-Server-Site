...
module.exports = (sequelize) => {
    const OutboundOrderLine = sequelize.define('OutboundOrderLine', {
        id: {
        ...
        tableName: 'outbound_order_lines',
        timestamps: true,
        underscored: true,
        indexes: [
            { unique: true, fields: ['outbound_order_id', 'merchant_sku_id'], name: 'uq_outbound_order_lines' },
