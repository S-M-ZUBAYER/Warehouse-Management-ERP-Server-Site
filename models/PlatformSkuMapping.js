...
//         paranoid: true,
//         indexes: [
//             { fields: ['platform_store_id', 'merchant_sku_id'], name: 'idx_psm_store_merchant' },
...
module.exports = (sequelize) => {
    const PlatformSkuMapping = sequelize.define('PlatformSkuMapping', {
        ...
        platform_shop_id:      { type: DataTypes.STRING(100), allowNull: true },
        platform_open_id:      { type: DataTypes.STRING(100), allowNull: true },
        platform_cipher_id:    { type: DataTypes.STRING(100), allowNull: true },
        platform_product_id:   { type: DataTypes.STRING(100), allowNull: true },
        platform_warehouse_id: { type: DataTypes.STRING(100), allowNull: true },
        platform_item_id:      { type: DataTypes.STRING(100), allowNull: true },
        platform_location_id:  { type: DataTypes.STRING(100), allowNull: true },
        // ───────────────────────────────────────────────────────────────────
