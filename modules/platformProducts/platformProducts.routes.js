...
// Merchant SKU list for product-side mapping/change modal. Must stay before any /:id route.
router.get('/:productId/merchant-sku-options', ctrl.getMerchantSkuOptions);
