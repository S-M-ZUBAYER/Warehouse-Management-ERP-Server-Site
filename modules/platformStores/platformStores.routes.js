...
const publicCreateValidator = [
    body('companyId').notEmpty().isInt({ min: 1 }).withMessage('companyId is required'),
    ...createValidator,
];
...
module.exports.publicCreateValidator = publicCreateValidator;
