...
router.use('/platform-products', require('../modules/platformProducts/platformProducts.routes'));
router.use('/sku-sync-groups', require('../modules/skuSyncGroup/skuSyncGroup.routes'));
