        ...
        RegisterRequest: {
            ...
            properties: {
                ...
                avatar: {
                    type: 'string',
                    maxLength: 6990508,
                    description: 'Optional base64 image, with or without a data:image/...;base64, prefix. Supports JPEG, PNG, WEBP, GIF, and AVIF. Decoded image must be 5MB or smaller.',
                },
            },
        },
        LoginRequest: {
        ...
        '/auth/register': {
            post: {
                ...
                responses: {
                    ...
                    413: { description: 'Avatar or request body too large' },
