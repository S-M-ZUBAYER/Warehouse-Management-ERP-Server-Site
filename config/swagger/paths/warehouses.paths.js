module.exports = {
    ...
    schemas: {
        WarehouseResponse: {
            ...
            properties: {
                ...
                state: { type: 'string', example: 'Selangor', nullable: true },
                zip_code: { type: 'string', example: '50450', nullable: true },
        ...
        CreateWarehouseRequest: {
            ...
            properties: {
                ...
                state: { type: 'string', maxLength: 100, example: 'Selangor', description: 'State' },
                zipCode: { type: 'string', maxLength: 30, example: '50450', description: 'ZIP/postal code' },
        ...
        UpdateWarehouseRequest: {
            ...
            properties: {
                ...
                state: { type: 'string', maxLength: 100, example: 'Selangor' },
                zipCode: { type: 'string', maxLength: 30, example: '50450' },
    ...
    paths: {
        '/warehouses': {
            get: {
                tags: ['Warehouses', 'Platform Manual Orders'],
                summary: 'Get all warehouses for the company',
                description: 'Returns paginated list. Default warehouse is always first. When only companyId is provided, this route returns lightweight warehouse options for Platform Manual Orders.',
                security: [{ bearerAuth: [] }],
                parameters: [
                    { in: 'query', name: 'companyId', schema: { oneOf: [{ type: 'string' }, { type: 'number' }] }, description: 'Company ID. If this is the only query param, returns Platform Manual Order warehouse options.' },
