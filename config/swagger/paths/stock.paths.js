        ...
        '/stock/ledger': {
            get: {
                ...
                parameters: [
                    ...
                    { in: 'query', name: 'startDate', schema: { type: 'string', format: 'date' }, description: 'Filter ledger entries from this date, inclusive' },
                    { in: 'query', name: 'endDate', schema: { type: 'string', format: 'date' }, description: 'Filter ledger entries through this date, inclusive' },
