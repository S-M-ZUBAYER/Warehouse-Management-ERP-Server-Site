    ...
    schemas: {
        MerchantSkuMapping: {
            ...
            properties: {
                ...
                fulfillment_warehouse_id:   { type: 'integer', nullable: true, example: 6 },
                fulfillment_warehouse_name: { type: 'string', nullable: true, example: 'Grozziie' },
        ...
        MerchantSkuListItem: {
            ...
            properties: {
                ...
                warehouse_id:     { type: 'integer', nullable: true, example: 6 },
                warehouse_name:   { type: 'string', nullable: true, example: 'Grozziie' },
        ...
        '/sku-mapping/by-merchant': {
            get: {
                ...
                parameters: [
                    ...
                    {
                        in: 'query', name: 'platformStoreId',
                        schema: { type: 'integer', example: 55 },
                        description: 'Optional internal platform store ID filter. Returns only SKUs/mappings for this store.',
                    },
                    {
                        in: 'query', name: 'platformShopId',
                        schema: { type: 'string', example: '7495574002249337724' },
                        description: 'Optional external platform shop ID filter. Returns only SKUs/mappings for this shop.',
                    },
                ],
                responses: {
                    200: {
